...
__title__ = "make Polymer Tantalum Caps 3D models"
__author__ = "Thomas Figueroa; aided by maurice and hyOzd"
__Comment__ = 'make Polymer Tantalum Caps 3D models exported to STEP and VRML for Kicad StepUP script'
...
import cq_params_poly_tantalum  # modules parameters
from cq_params_poly_tantalum import *

all_params= all_params_poly_tantalum

def make_poly_tantalum(params):
...
# maui     run()
    ...
    for variant in variants:
        ...
        case, pins, pinmark = make_poly_tantalum(all_params[variant])
