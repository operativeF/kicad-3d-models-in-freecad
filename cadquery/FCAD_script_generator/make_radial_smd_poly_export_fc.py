...
import cq_params_radial_smd_poly_cap  # modules parameters
from cq_params_radial_smd_poly_cap import *

all_params= all_params_radial_smd_poly_cap

def make_radial_smd_poly(params):
...
# maui     run()
    ...
    for variant in variants:
        ...
        body, base, mark, pins = make_radial_smd_poly(all_params[variant])
